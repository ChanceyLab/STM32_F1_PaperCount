...
#define OLED_DC      GPIO_Pin_15      //DC
#define OLED_RCCENA  RCC_APB2Periph_GPIOA
...
#define OLED_DC_OH		GPIO_SetBits(OLED_GPIOA, OLED_DC) 	//DC IO口输出高电平
...
#define OLED_RS_Set()   GPIO_SetBits(OLED_GPIOA, OLED_DC) 	  //DC IO口输出高电平
...
void disply_caiquan(u8 mode);
void OLED_ShowCHinese2(u8 x,u8 y,u8 no);
void display_order(u8 mode);
void disply_huaquan(u8 mode);
void Draw_Logo_1(void);
void Draw_Logo_2(void);
void Draw_Logo_3(void);
void Draw_shuzi_1(void);
void Draw_shuzi_2(void);
void Draw_shuzi_3(void);
void Draw_shuzi_4(void);
void Draw_shuzi_5(void);
void OLED_ShowCHinese3(u8 x,u8 y,u8 no);
void welcome_(void);
void start(void);
void end(void);
#endif
